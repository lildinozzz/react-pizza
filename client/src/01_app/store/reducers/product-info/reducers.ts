...
export const getAllProductsBySearch = createAsyncThunk<TProduct[], string>(
  "products/getAllProductsBySearch",
  (query: string) => productsService.getAllProductsBySearch(query)
);
